...
//apps/drive/frontend/browser/chrome/extensions/save_to_drive/extension/js/contentscriptraw.js
goog.loadModule(function(exports) {'use strict';/**
 * @fileoverview Content Script injected into page to send raw HTML to the
 * background page in response to the browser action.
 */
goog.module('gdocs.ContentScriptRaw');

/**
 * Content Script to add an HTML comment about download time and
 * location, then send the raw HTML to the background page.
 * @unrestricted
 */
class ContentScriptRaw {
  constructor() {}
  ...
  init() {
    ...
    const html = this.createHeader_() + htmlElem.outerHTML;
